		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form id="subcat_form" method="POST" action="/Insertsubcat" >
						@csrf
							...
							<div class="col-sm-12 col-md-10">
									...
									<option value="" >Select Main Category</option>
										@foreach($maincat_data as $row)
											<option value="{{ $row->maincat_id }}">{{ $row->cat_name }}</option>
										@endforeach
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" placeholder="Enter sub category name" type="text" name="subcat_name" >
							</div>
						</div>
