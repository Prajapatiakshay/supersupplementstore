		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">All Main Categorys</h4>
						...
						<table class="data-table table stripe hover nowrap">
							...
							<?php 
								...
								<tr>
									...
									<td class="table-plus"><div><a href="{{ URL::to('/')}}/upload/category/{{ $row->cat_img }}" target="_blank" rel="noopener noreferrer"><img src="{{ URL::to('/')}}/upload/category/{{ $row->cat_img }}" style="height: 70px;width: 70px;border-radius: 50%;" ></a></div></td>
									<td>{{ $row->cat_name }}</td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="/Maincatedit/{{ $row->maincat_id }}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item btn_delete" data-toggle="modal" data-target="#confirmation-modal" data-id="{{ $row->maincat_id }}" data-img="{{ $row->cat_img }}"  href="#"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
