				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
							<a class="btn btn-primary" href="/Subcatadd" role="button">Add Category</a>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="/Subcatedit/{{ $row->subcat_id }}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item btn_delete"  data-toggle="modal" data-target="#confirmation-modal" data-id="{{ $row->subcat_id }}" href="#"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
									...
									<form action="/Deletesubcat" method="post" >
										...
										<div class="modal-body text-center font-18">
											...
											<div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
													...
													<input type="hidden" name="hidd_subid" id="hidd_delid">
