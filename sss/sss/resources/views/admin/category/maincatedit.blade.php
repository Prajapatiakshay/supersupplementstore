			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form id="maincat_form" enctype="multipart/form-data" method="POST" action="/Updatemaincat" >
						...
						<input class="form-control" value="{{ $main_data->maincat_id }}" type="hidden" name="txtcatid" >
						<input class="form-control" value="{{ $main_data->cat_img }}" type="hidden" name="txtoldimage" >

						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Category Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control"  placeholder="Enter main category name" value="{{ $main_data->cat_name }}" type="text" name="maincat_name" >
						...
						<div class="form-group row">
							...
							<img src="{{ URL::to('/')}}/upload/category/{{ $main_data->cat_img }}" style="height: 100px;width: 100px;border-radius: 50%;" >
							</div>
						</div>
						<br>
						<div class="form-group row">
