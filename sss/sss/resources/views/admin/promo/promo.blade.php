...
<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			@if(Session::has('success'))
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Promocode</h4>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="/Promocodeedit/{{ $row->promo_id }}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item btn_delete"  data-toggle="modal" data-target="#confirmation-modal" data-id="{{ $row->promo_id }}" href="#"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
	...
	<div class="modal fade" id="confirmation-modal" tabindex="-1" role="dialog" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered" role="document">
									...
									<form action="/Deletepromocode" method="post" >
										@csrf
										<div class="modal-body text-center font-18">
											...
											<div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
													...
													<input type="hidden" name="hidd_promoid" id="hidd_delid">
