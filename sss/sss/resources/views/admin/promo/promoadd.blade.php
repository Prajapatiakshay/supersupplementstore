		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			@if(Session::has('success'))
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Promo-code</h4>
							<br>
					...
					<form method="POST" action="/Promocodeinsert" >
						@csrf
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Promo-Code</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="<?php echo $rand; ?>" readonly type="text" name="promocode" >
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Promo-Code description</label>
							<div class="col-sm-12 col-md-10">
							<input type="text" name="disc" placeholder="Enter promo-code description" class="form-control">
						</div>
					</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Promo Discount</label>
							<div class="col-sm-12 col-md-10">
							<input type="number" name="prodisc" placeholder="Enter promo-code discount" class="form-control">
						</div>
						</div>
						<br>
						<div class="form-group row">
