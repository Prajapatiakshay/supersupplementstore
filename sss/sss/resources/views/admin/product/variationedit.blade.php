		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			@if(Session::has('success'))
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Edit product veriation</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit Product veriation</h4>
					...
					<form id="variation_form" method="POST" action="/Updateveriation" >
					@csrf

					<input class="form-control" value="{{ $var_data->var_id }}" type="hidden" name="txtvarid" >
								...
								<div class="form-group">
									...
									<option value="">Select Product</option>
										@foreach($pro_data as $row)
											<option @if($var_data->pro_id == $row->pro_id ) selected @endif value="{{ $row->pro_id }}">{{ $row->p_name }}</option>
										@endforeach
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Flover</label>
									<input type="text" value="{{ $var_data->flavor }}" name="pro_flover" class="form-control">								
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label>Gram</label>
									<input type="number" value="{{ $var_data->gram }}" name="pro_gram" class="form-control">
								</div>
							</div>
<!-- ============================= -->
...
<!-- ============================= -->
						...
						<div class="col-md-3 col-sm-12">
								<div class="form-group">
									...
									<input type="number" value="{{ $var_data->s_price }}" id="price" name="pro_price" class="form-control">
								</div>
							</div>
							...
							<div class="col-md-3 col-sm-12">
								<div class="form-group">
									<label>MRP</label>
									<input type="number" value="{{ $var_data->mrp }}" id="mrp" name="pro_mrp" class="form-control">								
								</div>
							</div>
							...
							<div class="col-md-3 col-sm-12">
								<div class="form-group">
									...
									<input type="number" value="{{ $var_data->tot_qty }}" name="tot_qty" class="form-control">
								</div>
							</div>
