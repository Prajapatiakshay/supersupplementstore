						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
							<div class="pd-20 card-box height-100-p">
								<div class="profile-photo">
									...
									<a href="{{ URL::to('/')}}/upload/product/{{ $pro_data->p_image }}" target="_blank" rel="noopener noreferrer"><img src="{{ URL::to('/') }}/upload/product/{{ $pro_data->p_image }}" style="width: 120px;" alt="" ></a>
									<!-- border-radius: 50%; -->
											...
											<div class="modal-content">
												<div class="modal-body pd-5">
													<div class="img-container">
														<img id="image" src="{{ URL::to('/') }}/upload/product/{{ $pro_data->p_name }}" alt="Picture">
													</div>
												</div>
								...
								<h5 class="text-center h5 mb-0">{{ $pro_data->p_name }}</h5>
...
<br>
								<div class="profile-info">
								<!-- <br> -->
									<center><h5 class="mb-20 h5 text-blue">Product Variation</h5></center>	
