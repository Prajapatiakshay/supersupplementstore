...
<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Manage Processing Orders</h4>
							</div>
				...
				<a href="/Processingorder" >
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								<div class="h4 mb-0"style="color:#474ac3"><?php echo $proc_count; ?></div>
								<div class="weight-600 font-18" style="color:#474ac3">Packging Order</div>
							</div>
						</div>
					</div>
					</a>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">All Processing Orders</h4>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap">
							...
							<?php 
								$i = 0;
							?>								
								@foreach($processing_ord_data as $row)
							<?php 
								$i++;
							?>
							<?php
								...
								<tr>
									...
									<td><center><button type="button" data-id="{{ $row->ord_id }}" id="pan_ord" class="btn btn-primary btn-sm move_com">Move TO Complated</button></center></td>
	...
	<script>
		$(document).ready(function(){
			$(".move_com").click(function(){
				var del_id = $(this).attr("data-id");
				// alert(del_id);
				$("#hidd_ordid").val(del_id);

				window.location.href = '/processing_to_complated/' + del_id;
