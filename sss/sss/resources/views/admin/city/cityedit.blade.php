		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			@if(Session::has('success'))
				...
				<div class="pd-20 card-box mb-30">
					...
					<form id="city_form" method="POST" action="/Updatecity" >
						@csrf
						<input type="hidden" name="hidd_city" value="{{ $city_data->city_id }}">
							...
							<div class="col-sm-12 col-md-10">
									...
									<option value="" >Select state</option>
										@foreach($state_data as $row)
											<option @if($city_data->state_id == $row->state_id) selected @endif value="{{ $row->state_id }}">{{ $row->s_name }}</option>
										@endforeach
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="{{ $city_data->c_name }}" type="text" name="c_name" >
							</div>
						</div>
