				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
							<a class="btn btn-primary" href="/Cityadd" role="button">Add City</a>
						...
						<table class="data-table table stripe hover nowrap">
							...
							?>
								<tr>
									...
									<td value="{{ $row->state_id }}">{{ $row->s_name }}</td>
									<td>{{ $row->c_name }}</td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="/Cityedit/{{ $row->city_id }}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item btn_delete" data-toggle="modal" data-target="#confirmation-modal" data-id="{{ $row->city_id }}"  href="#"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
									...
									<form action="/Deletecity" method="post" >
										<div class="modal-body text-center font-18">
											...
											<div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
													...
													@csrf
													<input type="hidden" name="city_id" id="hidd_delid">
