		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Edit State</h4>
							<br>
							<!-- <p class="mb-30">All bootstrap element classies</p> -->
						</div>
						
					</div>
					<form id="state_form" method="POST" action="/Updatestate">
						@csrf

						<input type="hidden" value="{{ $state_data->state_id }}" name="hide_sid" >

						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">State Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="{{ $state_data->s_name }}" placeholder="Enter state name" type="text" name="s_name" >
							</div>
						</div>
						<!-- <div class="form-group row">
						...
						<button type="submit" name="action" class="btn btn-success btn-lg btn-block">Submit</button>
						</div>
						</div>
					</form>
