		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
							<a class="btn btn-primary" href="/Stateadd" role="button">Add State</a>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">State</h4>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="/Stateedit/{{ $row->state_id}}"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item btn_delete" data-toggle="modal" data-target="#confirmation-modal" data-id="{{ $row->state_id }}"   href="#"><i class="dw dw-delete-3"></i> Delete</a>
											</div>																												<!-- data-img="{{ $row->b_icon }}" -->
										</div>
									</td>
								</tr>	
							@endforeach
									...
									<form action="/Deletestate" method="post" >
										<div class="modal-body text-center font-18">
											...
											<div class="padding-bottom-30 row" style="max-width: 170px; margin: 0 auto;">
													...
													@csrf
													<input type="hidden" name="state_id" id="hidd_delid">
