...
@section('css')
 ...
 <link href="{{ URL::to('/') }}/user/css/bootstrap.custom.min.css" rel="stylesheet">
	...
	<!-- SPECIFIC CSS -->
    <link href="{{ URL::to('/') }}/user/css/cart.css" rel="stylesheet">
		...
		<table class="table table-striped cart-list">
							...
							<tbody>
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/1.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/2.jpg" class="lazy" alt="Image">
										</div>
								...
								<tr>
									<td>
										<div class="thumb_cart">
											<img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/3.jpg" class="lazy" alt="Image">
										</div>
