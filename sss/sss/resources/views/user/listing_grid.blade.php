...
@section('css')
	...
	<!-- SPECIFIC CSS -->
	<link href="{{ URL::to('/') }}/user/css/listing.css" rel="stylesheet">
...
@section('js')
	...
	<!-- SPECIFIC SCRIPTS -->
	<script src="{{ URL::to('/') }}/user/js/sticky_sidebar.min.js"></script>
	<script src="{{ URL::to('/') }}/user/js/specific_listing.js"></script>
@endsection
...
<main>
			<div class="top_banner">
				...
				<img src="{{ URL::to('/') }}/user/img/bg_cat_shoes.jpg" class="img-fluid" alt="">
			</div>
			<!-- /top_banner -->
							...
							<div class="col-6 col-md-4">
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/2.jpg" alt="">
										</a>
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/3.jpg" alt="">
										</a>
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/4.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/5.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/6.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/7.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
										<h3>Armor Air 98</h3>
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/8.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
										<h3>Armor Air 720</h3>
								...
								<div class="grid_item">
									...
									<figure>
										<a href="product-detail-1.html">
											<img class="img-fluid lazy"
												src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg"
												data-src="{{ URL::to('/') }}/user/img/products/shoes/9.jpg" alt="">
										</a>
									</figure>
									<a href="product-detail-1.html">
										<h3>Armor 720</h3>
