			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="step middle payments">
						<h3>2. Payment and Shipping</h3>
							...
							<div class="payment_info d-none d-sm-block"><figure><img src="{{ URL::to('/') }}/user/img/cards_all.svg" alt=""></figure>	<p>Sensibus reformidans interpretaris sit ne, nec errem nostrum et, te nec meliore philosophia. At vix quidam periculis. Solet tritani ad pri, no iisque definitiones sea.</p></div>
				...
				<div class="col-lg-4 col-md-6">
					...
					<div class="box_general summary">
						...
						<a href="/Confirmorder" class="btn_1 full-width">Confirm and Pay</a>
					</div>
					<!-- /box_general -->
					</div>
					<!-- /step -->
