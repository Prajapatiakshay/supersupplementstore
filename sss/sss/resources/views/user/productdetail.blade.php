...
<link href="{{ URL::to('/') }}/user/css/bootstrap.custom.min.css" rel="stylesheet">
	...
	<!-- SPECIFIC CSS -->
    <link href="{{ URL::to('/') }}/user/css/product_page.css" rel="stylesheet">
...
<script src="{{ URL::to('/') }}/user/js/common_scripts.min.js"></script>
    ...
    <!-- SPECIFIC SCRIPTS -->
    <script  src="{{ URL::to('/') }}/user/js/carousel_with_thumbs.js"></script>
@endsection
	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(user/img/products/shoes/1.jpg);" class="item-box"></div>
	                            <div style="background-image: url(user/img/products/shoes/2.jpg);" class="item-box"></div>
	                            <div style="background-image: url(user/img/products/shoes/3.jpg);" class="item-box"></div>
	                            <div style="background-image: url(user/img/products/shoes/4.jpg);" class="item-box"></div>
	                            <div style="background-image: url(user/img/products/shoes/5.jpg);" class="item-box"></div>
	                            <div style="background-image: url(user/img/products/shoes/6.jpg);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(user/img/products/shoes/1.jpg);" class="item active"></div>
	                            <div style="background-image: url(user/img/products/shoes/2.jpg);" class="item"></div>
	                            <div style="background-image: url(user/img/products/shoes/3.jpg);" class="item"></div>
	                            <div style="background-image: url(user/img/products/shoes/4.jpg);" class="item"></div>
	                            <div style="background-image: url(user/img/products/shoes/5.jpg);" class="item"></div>
	                            <div style="background-image: url(user/img/products/shoes/6.jpg);" class="item"></div>
	                        </div>
	                ...
	                <div id="pane-B" class="card tab-pane fade" role="tabpanel" aria-labelledby="tab-B">
	                    ...
	                    <div id="collapse-B" class="collapse" role="tabpanel" aria-labelledby="heading-B">
	                        <div class="card-body">
	                            ...
	                            <!-- /row -->
	                            <p class="text-right"><a href="/Review" class="btn_1">Leave a review</a></p>
	                        </div>
	                        <!-- /card-body -->
	                    </div>
	                </div>
	        ...
	        <div class="owl-carousel owl-theme products_carousel">
	                ...
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="/Productdetail">
	                            <img class="owl-lazy" src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/4.jpg" alt="">
	                        </a>
	                    </figure>
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="/Productdetail">
	                            <img class="owl-lazy" src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/5.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="/Productdetail">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="/Productdetail">
	                            <img class="owl-lazy" src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/8.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="/Productdetail">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="/Productdetail">
	                            <img class="owl-lazy" src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/2.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="/Productdetail">
	            ...
	            <div class="item">
	                <div class="grid_item">
	                    ...
	                    <figure>
	                        <a href="/Productdetail">
	                            <img class="owl-lazy" src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_medium.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/3.jpg" alt="">
	                        </a>
	                    </figure>
	                    <div class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star voted"></i><i class="icon-star"></i></div>
	                    <a href="/Productdetail">
	            ...
	            <div class="row">
	                <div class="col-md-7">
	                    <div class="item_panel">
	                        <figure>
	                            <img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/1.jpg" class="lazy" alt="">
	                        </figure>
	        ...
	        <div class="row">
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/2.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
	            ...
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/3.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
	            ...
	            <div class="col-md-4">
	                <div class="item_panel">
	                    <a href="#0">
	                        <figure>
	                            <img src="{{ URL::to('/') }}/user/img/products/product_placeholder_square_small.jpg" data-src="{{ URL::to('/') }}/user/img/products/shoes/4.jpg" alt="" class="lazy">
	                        </figure>
	                    </a>
	                    <a href="#0">
